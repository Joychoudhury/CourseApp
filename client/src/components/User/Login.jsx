...
const Login = () => {
    ...
    const handleLogin = async () => {
        try {
            const response = await axios.post('http://localhost:3000/user/login', {}, { headers: { username, password } })
        ...
        <div>
            ...
            <div className='center bg' >
                <Card style={{ margin: '4rem' }} className='card' variant="outlined">
                    ...
                    <Typography variant='body2' >Dont have a account ? <span onClick={() => navigate('/signup')} style={{ color: '#2CD3E1', cursor: 'pointer' }}>Register</span></Typography>
                </Card>
            </div>
        </div>
    )
